...
class MetaMysqlRepository:
    ...
    async def get_key_columns_by_table_id(self, table_id: str) -> list[ColumnInfo]:
        ...
        return [ColumnInfoMapper.to_entity(row[0]) for row in result.fetchall()]